...
- runtime-интеграция `Kilo Notebook V3` не выполнена (Phase 4);
...
`templates/` и `prompts/` — наполнены в Phase 3 (шаблоны и промпты). `docs/` — пока содержит placeholder README.
