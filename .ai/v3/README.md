...
- `scripts/v3/*` созданы (Phase 7 foundation): validate, stage, journal helpers. Автоматический apply не создан. Manual flow остаётся primary.
...
- Phase 7 foundation запущен: `scripts/v3/` helper layer создан (validate, stage, journal draft). `/v3` shortcut не активирован. `apply_v3_package.py` не создан.
...
Phase 7 foundation создан (scripted helpers существуют),
/v3 shortcut не активирован,
