...
| V3-20260530-130503-hierarchical-subproject-working-plan | 2026-05-30 | `imported` | Короткий operational work plan по внедрению hierarchical subproject / Boss / B1 workflow на основе большого master plan и idea doc | `.ai/v3/requests/V3-20260530-130503-hierarchical-subproject-working-plan_request.md` | `.ai/v3/requests/V3-20260530-130503-hierarchical-subproject-working-plan_prompt.md` | `local-only zip path: C:/Users/andre/Downloads/V3-20260530-130503-hierarchical-subproject-working-plan-ru.zip` | `.ai/v3/journals/drafts/V3-20260530-130503-hierarchical-subproject-working-plan_journal.yaml` | `.ai/plans/implementation/hierarchical_subproject_workflow_work_plan.md` | External chat generated Russian working plan for rollout. Package validated: manifest OK, SHA256 verified, path allowed. One planning file created. Journal draft created. Post-import testing waived. Codex review and human acceptance still pending. |
| V3-20260531-061138-planner-orc-doc-migration-plan | 2026-05-31 | `imported` | Подробный migration plan документации от legacy B1/BOS системы к active Planner -> Orc системе | `.ai/v3/requests/V3-20260531-061138-planner-orc-doc-migration-plan_request.md` | `.ai/v3/requests/V3-20260531-061138-planner-orc-doc-migration-plan_prompt.md` | `local-only zip path: C:/Users/andre/Downloads/V3-20260531-061138-planner-orc-doc-migration-plan.zip` | `.ai/v3/journals/drafts/V3-20260531-061138-planner-orc-doc-migration-plan_journal.yaml` | `.ai/plans/implementation/planner_orc_documentation_migration_plan.md` | External chat generated detailed migration plan from B1/BOS to Planner -> Orc documentation system. Package validated: manifest OK, SHA256 verified, path allowed, no overwrite. One planning file created. Journal draft created. Post-import testing waived. Codex review and human acceptance still pending. |

| V3-20260531-072402-planner-orc-role-rules-split | 2026-05-31 | `imported` | Split Codex role rules documents for Planner and Orc (по запросу человека — 2 отдельных файла) | `.ai/v3/requests/V3-20260531-072402-planner-orc-role-rules-split_request.md` | `.ai/v3/requests/V3-20260531-072402-planner-orc-role-rules-split_prompt.md` | `local-only zip path: C:/Users/andre/Downloads/V3-20260531-072402-planner-orc-role-rules-split.zip` | `.ai/v3/journals/drafts/V3-20260531-072402-planner-orc-role-rules-split_journal.yaml` | `.ai/rules/codex_role_planner.md, .ai/rules/codex_role_orc.md` | Human override: split accepted, manifest rewritten to standard V3 schema. Two role rules files created under `.ai/rules/`. SHA256 verified. Journal draft created. Codex review and human acceptance still pending. |
| V3-20260531-091439-ork-planner-doc-critique | 2026-05-31 | `package_reviewed` | External critique and analysis review of ork_planner subproject docs | `—` | `—` | `local-only zip path: C:/Users/andre/Downloads/V3-20260531-091439-ork-planner-doc-critique.zip` | `.ai/v3/journals/drafts/V3-20260531-091439-ork-planner-doc-critique_journal.yaml` | `.ai/subprojects/ork_planner/reviews/V3-ork_planner_readme.md, .ai/subprojects/ork_planner/reviews/V3-ork_planner_navigation.md, .ai/subprojects/ork_planner/reviews/V3-ork_planner_plan_full.md, .ai/subprojects/ork_planner/reviews/V3-ork_planner_plan_index.md, .ai/subprojects/ork_planner/reviews/V3-ork_planner_plan_active_1.md, .ai/subprojects/ork_planner/reviews/V3-ork_planner_journal.md, .ai/subprojects/ork_planner/reviews/V3-ork_planner_status.md, .ai/subprojects/ork_planner/reviews/V3-ork_planner_decisions.md` | External chat critique of 8 ork_planner subproject docs imported and reviewed by Codex. Conservative subset of findings accepted into source-doc revisions. Human verdict on resulting docs still pending. |
| V3-20260601-091540-ork-planner-stage3-battle-plan | 2026-06-01 | `package_reviewed` | Один русский Stage 3 battle plan для local docs wave после принятого Stage 2 | `.ai/v3/requests/V3-20260601-091540-ork-planner-stage3-battle-plan_request.md` | `.ai/v3/requests/V3-20260601-091540-ork-planner-stage3-battle-plan_prompt.md` | `local-only zip path: D:/Codex+Kilocode/projects/sword-of-rome-web/_local/v3_drafts/ork_planner/V3-20260601-091540-ork-planner-stage3-battle-plan-ru-v4-stage5-orc-prompt.zip` | `—` | `.ai/subprojects/ork_planner/ork_planner_battle_plan.md` | Внешний пакет получен и review-нут локально. Формальный V3 manifest оказался неполным, а draft слишком широко раскрывал Stage 5/Stage 6. Codex использовал его как source draft, создал локальный `ork_planner_battle_plan.md` и сузил battle plan до Stage 4 local docs wave. Human approval battle plan всё ещё pending. |
| V3-20260602-083104-v3-request-pack-skill-plan-draft | 2026-06-02 | `imported` | External draft full plan for v3_request_pack_skill_pilot subproject | `—` | `—` | `local-only zip path: C:/Users/andre/Downloads/V3-20260602-083104-v3-request-pack-skill-plan-draft.zip` | `.ai/v3/journals/drafts/V3-20260602-083104-v3-request-pack-skill-plan-draft_journal.yaml` | `.ai/subprojects/v3_request_pack_skill_pilot/v3_request_pack_skill_pilot_plan_full_draft.md` | External chat generated full planning draft for the v3_request_pack_skill_pilot subproject. Package validated: manifest OK, SHA256 verified, path allowed, no overwrite. One workflow_docs file created. Journal draft created. Post-import testing waived. Codex review and human acceptance still pending. |
| V3-20260605-141503-token-cost-normalizer-v1 | 2026-06-05 | `imported` | External implementation-pack draft for Token Cost Normalizer v1 in `tokken_dashboard` | `.ai/v3/requests/V3-20260605-141503-token-cost-normalizer-v1_request.md` | `.ai/v3/requests/V3-20260605-141503-token-cost-normalizer-v1_prompt.md` | `local-only zip path: C:/Users/andre/Downloads/V3-20260605-141503-token-cost-normalizer-v1.zip` | `.ai/v3/journals/drafts/V3-20260605-141503-token-cost-normalizer-v1_journal.yaml` | `.ai/subprojects/tokken_dashboard/drafts/token_cost_normalizer_v1_implementation_pack.md` | External chat generated one workflow_docs implementation pack markdown for Token Cost Normalizer v1. Package validated: manifest OK, SHA256 verified, path allowed, no overwrite. One workflow_docs file created. Journal draft created. Post-import testing waived. Codex review and human acceptance still pending. |
