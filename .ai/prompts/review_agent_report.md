...
- concrete ли `Verification` в bug section;
- нет ли нарушений language policy в новых technical identifiers;
- если human check failed или pending, не объявлен ли результат ложно fully done.
...
- [ ] В report есть `Баги и сложности`.
- [ ] В report есть `Human Check`.
- [ ] `Human Check` соответствует типу задачи, а не вставлен формально.
- [ ] `Verification` в bug section concrete.
- [ ] Если нужно, bug journal lookup / update явно отражен.
