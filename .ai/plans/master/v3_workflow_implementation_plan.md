...
Версия: 0.2  
Статус: Phase 0 завершён, Phase 1 pending  
...
- при необходимости [`../../../README.md`](../../../README.md) или workflow-обзор, если V3 должен стать частью стартовой навигации.
...
- `validate_kilo_contract.py` сейчас не покрывает даже текущий `kilo-notebook`;
