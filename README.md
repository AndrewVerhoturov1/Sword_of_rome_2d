...
По состоянию на 2026-05-23 этот repo в основном содержит публичный проектный контекст, workflow-слой, канон, референсы и историю внешних проверок.

Первый product-code block для editor/runtime ещё не разложен здесь как реализованное приложение. Подробные архитектурные документы описывают целевой замысел и принятые направления, а не уже готовый рабочий runtime.
